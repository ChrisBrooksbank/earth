...
- [ ] Create src/components/Planet.tsx: generic component accepting radius, texture, axialTilt, rotationSpeed props (spec: solar-system.md)
...
- [ ] Create src/lib/orbital-mechanics.ts: Kepler equation solver (Newton-Raphson), 3D position from 6 Keplerian elements (spec: solar-system.md)
- [ ] Create src/data/orbital-elements.json: NASA JPL Keplerian elements for all bodies (spec: solar-system.md)
